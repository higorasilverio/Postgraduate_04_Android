...
import br.com.silverio.postgraduate_04.databinding.ItemProductBinding
import br.com.silverio.postgraduate_04.persistence.Product

class ProductAdapter(val onProductClickListener: ProductClickListener) : ListAdapter<Product, ProductAdapter.ProductViewHolder>(ProductDiff) {
